 ...
 */
public class HeaderSvmConstants {

    public static String BJELLPI_INSTANCE_HEADER  = "BjellPI";

    public static String ZIMMERPI_INSTANCE_HEADER = "ZimmermanPI";

    public static String CLASS_INSTANCE_HEADER    = "Class";

    public static String DEFAULT_DATA_NAME = "svmData";

    public static String AA_NAME_HEADER          = "AA Name ";
    ...
    public static final String INDEX_AVG                             = "Index Avg";

    public static final String KYTEDOOLITTLE                         = "KyteDoolittle";

    public static final String BULKINESS                             = "Bulkiness";

    public static String INDEX_SEQUENCE_LENGTH                        = "Sequence Length";

    public static String INDEX_RETENTION_TIME_AA                      = "Retention Time AA";

    public static final String INDEX_NUMBER_OF_AA                    = "Number of Ocurrences of AA ";
